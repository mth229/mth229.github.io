...
One such approximation is given by the familiar Riemann sums, which we
...
If we partition $[a,b]$ into $n$ same sized intervals, then each has
...
The Gauss nodes and weights are computable
