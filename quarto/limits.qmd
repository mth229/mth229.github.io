...
Related in that they are used to approximate related functions near $0$: $\sin(x) \approx x$ and $1 - \cos(x) \approx (1/2) x^2$. The latter approximation can be seen in  #fig-cos-parabola-0.
