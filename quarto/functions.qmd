...
We see in this section how to easily create functions in `Julia`. In the following sections we begin to do things with functions, such as learning how to graph functions with `Julia`.
...
* **Defining a function**, as above, can be done with the same syntax as mathematics. The function name with parentheses surrounds any arguments, and equal sign to indicated a *definition* and a rule on the right of the equals sign, indicating what becomes of the arguments.
